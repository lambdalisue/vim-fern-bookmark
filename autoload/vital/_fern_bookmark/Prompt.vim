...
execute join(['function! vital#_fern_bookmark#Prompt#import() abort', printf("return map({'select': '', 'ask': '', 'confirm': '', 'input': ''}, \"vital#_fern_bookmark#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
