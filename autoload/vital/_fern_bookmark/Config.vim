...
execute join(['function! vital#_fern_bookmark#Config#import() abort', printf("return map({'define': '', 'translate': '', 'config': ''}, \"vital#_fern_bookmark#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
